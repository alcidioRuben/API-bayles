 ...
 */
router.get('/sessions', auth_1.authMiddleware, (0, errorHandler_1.asyncHandler)(async (req, res) => {
    ...
    const sessionMetrics = await Promise.all(sessions.map(async (session) => {
        ...
        return {
            ...
            status: (liveSession === null || liveSession === void 0 ? void 0 : liveSession.status) || session.status,
...
router.get('/', (req, res) => {
    const dashboardPath = (0, path_1.join)(__dirname, '../../frontend/dist/index.html');
    if ((0, fs_1.existsSync)(dashboardPath)) {
